...
__export(index_exports, {
  ...
  FEE_TIER: () => FEE_TIER,
  GSwap: () => GSwap,
  GSwapSDKError: () => GSwapSDKError,
  GalaWalletSigner: () => GalaWalletSigner,
  ...
  Quoting: () => Quoting,
  Swaps: () => Swaps,
  TradeEventEmitter: () => TradeEventEmitter,
  compareTokens: () => compareTokens,
  getTokenOrdering: () => getTokenOrdering,
  parseTokenClassKey: () => parseTokenClassKey,
  stringifyTokenClassKey: () => stringifyTokenClassKey,
  validateFee: () => validateFee,
  validateNumericAmount: () => validateNumericAmount,
  validatePriceValues: () => validatePriceValues,
  validateTickRange: () => validateTickRange,
  validateTickSpacing: () => validateTickSpacing,
  validateTokenDecimals: () => validateTokenDecimals,
...
function validateNumericAmount(amount, parameterName, allowZero = false) {
  const bnAmount = (0, import_bignumber.default)(amount);
...
function validatePriceValues(spotPrice, lowerPrice, upperPrice) {
  const bnSpotPrice = (0, import_bignumber.default)(spotPrice);
  const bnLowerPrice = (0, import_bignumber.default)(lowerPrice);
  let bnUpperPrice = (0, import_bignumber.default)(upperPrice);
  bnUpperPrice = bnUpperPrice.isFinite() ? bnUpperPrice : (0, import_bignumber.default)(1e18);
...
var debugLog = (0, import_debug.default)("GSWAP_SDK");

// src/classes/event_socket_client.ts
var import_events = require("events");
var import_socket = require("socket.io-client");
var TradeEventEmitter = class extends import_events.EventEmitter {
};
var EventSocketClient = class extends TradeEventEmitter {
  ...
  connect() {
    return new Promise((resolve, reject) => {
      ...
      this.socket = (0, import_socket.io)(this.bundlerUrl, {
...
var Pools = class {
  ...
  async getPoolData(token0, token1, fee) {
    ...
    return {
      ...
      fee: rawData.fee,
      feeGrowthGlobal0: (0, import_bignumber2.default)(rawData.feeGrowthGlobal0),
      feeGrowthGlobal1: (0, import_bignumber2.default)(rawData.feeGrowthGlobal1),
      grossPoolLiquidity: (0, import_bignumber2.default)(rawData.grossPoolLiquidity),
      liquidity: (0, import_bignumber2.default)(rawData.liquidity),
      maxLiquidityPerTick: (0, import_bignumber2.default)(rawData.maxLiquidityPerTick),
      protocolFees: rawData.protocolFees,
      protocolFeesToken0: (0, import_bignumber2.default)(rawData.protocolFeesToken0),
      protocolFeesToken1: (0, import_bignumber2.default)(rawData.protocolFeesToken1),
      sqrtPrice: (0, import_bignumber2.default)(rawData.sqrtPrice),
  ...
  calculateTicksForPrice(price, tickSpacing) {
    ...
    const priceNumber = (0, import_bignumber2.default)(price).toNumber();
    if (priceNumber === 0) {
      return -886800;
    }
  ...
  calculatePriceForTicks(tick) {
    if (tick === -886800) {
      return (0, import_bignumber2.default)("0");
    } else if (tick === 886800) {
      return (0, import_bignumber2.default)(Infinity);
    } else {
      const price = Math.pow(1.0001, tick);
      return (0, import_bignumber2.default)(price);
    }
  }
  /**
  ...
  calculateSpotPrice(inToken, outToken, poolSqrtPrice) {
    ...
    const poolPrice = (0, import_bignumber2.default)(poolSqrtPrice).pow(2);
    if (ordering.zeroForOne) {
      return poolPrice;
    } else {
      return (0, import_bignumber2.default)(1).div(poolPrice);
    }
  }
};

// src/classes/positions.ts
var import_bignumber3 = __toESM(require("bignumber.js"), 1);
var Positions = class {
  ...
  async estimateRemoveLiquidity(args) {
    ...
    const responseBody = await this.httpClient.sendPostRequest(this.gatewayBaseUrl, this.dexContractBasePath, "/GetRemoveLiquidityEstimation", {
      ...
      amount: (0, import_bignumber3.default)(args.amount).toFixed(),
      token0: ordering.token0,
      token1: ordering.token1,
      fee: args.fee,
    ...
    return {
      amount0: (0, import_bignumber3.default)(responseBody.Data.amount0),
      amount1: (0, import_bignumber3.default)(responseBody.Data.amount1)
    };
  }
  /**
  ...
  async addLiquidityByTicks(args) {
    ...
    const toSign = {
      ...
      tickLower: args.tickLower,
      tickUpper: args.tickUpper,
      amount0Desired: (0, import_bignumber3.default)(ordering.token0Attributes[0]).toFixed(),
      amount1Desired: (0, import_bignumber3.default)(ordering.token1Attributes[0]).toFixed(),
      amount0Min: (0, import_bignumber3.default)(ordering.token0Attributes[1]).toFixed(),
      amount1Min: (0, import_bignumber3.default)(ordering.token1Attributes[1]).toFixed(),
      positionId: args.positionId
    };
  ...
  async addLiquidityByPrice(args) {
    ...
    validateNumericAmount(args.amount0Min, "amount0Min", true);
    validateNumericAmount(args.amount1Min, "amount1Min", true);
    if ((0, import_bignumber3.default)(args.minPrice).isGreaterThan((0, import_bignumber3.default)(args.maxPrice))) {
  ...
  async collectPositionFees(args) {
    ...
    const toSign = {
      ...
      token1: ordering.token1,
      fee: args.fee,
      amount0Requested: (0, import_bignumber3.default)(ordering.token0Attributes[0]).toFixed(),
      amount1Requested: (0, import_bignumber3.default)(ordering.token1Attributes[0]).toFixed(),
      tickLower: args.tickLower,
      tickUpper: args.tickUpper,
      positionId: args.positionId
    };
  ...
  calculateOptimalPositionSize(tokenAmount, spotPrice, lowerPrice, upperPrice, tokenDecimals, otherTokenDecimals) {
    ...
    const bnTokenAmount = (0, import_bignumber3.default)(tokenAmount);
    const bnSpotPrice = (0, import_bignumber3.default)(spotPrice);
    const bnLowerPrice = (0, import_bignumber3.default)(lowerPrice);
    let bnUpperPrice = (0, import_bignumber3.default)(upperPrice);
    bnUpperPrice = bnUpperPrice.isFinite() ? bnUpperPrice : (0, import_bignumber3.default)(1e18);
    ...
    const yAmount = (0, import_bignumber3.default)(liquidityAmount).times(bnSpotPrice.sqrt().minus(bnLowerPrice.sqrt()));
    const untruncated = yAmount.div((0, import_bignumber3.default)(10).pow(tokenDecimals - otherTokenDecimals));
    return import_bignumber3.default.max(
      (0, import_bignumber3.default)(untruncated.toFixed(otherTokenDecimals, import_bignumber3.default.ROUND_DOWN)),
      0
    );
  }
  async sendUserPositionsRequest(endpoint, body) {
    ...
    return {
      ...
      positions: responseBody.Data.positions.map((position) => ({
        ...position,
        liquidity: (0, import_bignumber3.default)(position.liquidity)
      }))
    };
  }
  async sendPositionRequest(endpoint, body) {
    ...
    return {
      ...responseBody.Data,
      feeGrowthInside0Last: (0, import_bignumber3.default)(responseBody.Data.feeGrowthInside0Last),
      feeGrowthInside1Last: (0, import_bignumber3.default)(responseBody.Data.feeGrowthInside1Last),
      liquidity: (0, import_bignumber3.default)(responseBody.Data.liquidity),
      tokensOwed0: (0, import_bignumber3.default)(responseBody.Data.tokensOwed0),
      tokensOwed1: (0, import_bignumber3.default)(responseBody.Data.tokensOwed1)
    };
  }
};

// src/classes/quoting.ts
var import_bignumber4 = __toESM(require("bignumber.js"), 1);
...
var Quoting = class {
  ...
  async getSingleQuote(tokenIn, tokenOut, fee, amount, isExactInput) {
    ...
    const formattedAmount = isExactInput ? (0, import_bignumber4.default)(amount).toFixed() : (0, import_bignumber4.default)(amount).multipliedBy(-1).toFixed();
    ...
    if (!ordering.zeroForOne) {
      currentPrice = (0, import_bignumber4.default)(1).dividedBy(currentPrice);
      newPrice = (0, import_bignumber4.default)(1).dividedBy(newPrice);
    }
  ...
  async sendQuoteRequest(endpoint, body) {
    ...
    return {
      amount0: (0, import_bignumber4.default)(responseBody.Data.amount0),
      amount1: (0, import_bignumber4.default)(responseBody.Data.amount1),
      currentSqrtPrice: (0, import_bignumber4.default)(responseBody.Data.currentSqrtPrice),
      newSqrtPrice: (0, import_bignumber4.default)(responseBody.Data.newSqrtPrice)
    };
  }
};

// src/classes/swaps.ts
var import_bignumber5 = __toESM(require("bignumber.js"), 1);
...
var Swaps = class {
  ...
  async swap(tokenIn, tokenOut, fee, amount, walletAddress) {
    ...
    const rawAmount = "exactIn" in amount ? (0, import_bignumber5.default)(amount.exactIn).toFixed() : (0, import_bignumber5.default)(amount.exactOut).multipliedBy(-1).toFixed();
    const rawAmountOutMinimum = "exactIn" in amount ? ((_b = amount.amountOutMinimum) == null ? void 0 : _b.toString()) ? (0, import_bignumber5.default)(amount.amountOutMinimum).multipliedBy(-1).toFixed() : void 0 : (0, import_bignumber5.default)(amount.exactOut ?? 0).multipliedBy(-1).toFixed();
    const rawAmountInMaximum = "exactIn" in amount ? (0, import_bignumber5.default)(amount.exactIn).toFixed() : amount.amountInMaximum ? (0, import_bignumber5.default)(amount.amountInMaximum).toFixed() : void 0;
    const toSign = {
...
var import_api = require("@gala-chain/api");
var import_connect = require("@gala-chain/connect");
var PrivateKeySigner = class {
  keyBuffer;
  constructor(privateKey) {
    this.keyBuffer = import_api.signatures.normalizePrivateKey(privateKey);
  }
  async signObject(_methodName, obj) {
    const signature = import_api.signatures.getSignature(obj, this.keyBuffer);
...
var GalaWalletSigner = class _GalaWalletSigner {
  ...
  async signObject(methodName, obj) {
    ...
    const signRequest = {
      ...
      message: {
        ...obj,
        prefix: (0, import_connect.calculatePersonalSignPrefix)(obj)
      }
    };
