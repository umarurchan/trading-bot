...
function toUtf8Bytes(str, form) {
    (0, errors_js_1.assertArgument)(typeof str === "string" || bignumber_js_1.default.isBigNumber(str), `invalid string or bignumber value`, "str or BN", str);
    if (bignumber_js_1.default.isBigNumber(str)) {
        str = str.toFixed();
    }
    if (form != null) {
